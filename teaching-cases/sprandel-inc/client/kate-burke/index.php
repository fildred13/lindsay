        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        	<div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Speak with Kate Burke</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <a href="/teaching-cases/sprandel-inc/client/kate-burke/shipping-docs.php" class="btn btn-primary col-xs-8 col-xs-offset-2">Ask for Shipping Documents for AR Invoices</a>
                    </div>
                    <div class="row">
