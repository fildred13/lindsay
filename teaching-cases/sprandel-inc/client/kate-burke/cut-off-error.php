        	...
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row margin-top-bottom margin-left-right well">
                        ...
                        <p class="col-sm-7 col-sm-offset-5">"I will provide any further support you require for additional credit memo cut-off testing for the accounts I manage. I am pretty sure Meg Black previously supplied you with the cut-off detail."</p>
                    </div> 
                </div>
            </div>  
            <div>
