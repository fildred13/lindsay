    ...
    <div class="container" role="main">
        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row margin-top-bottom margin-left-right well">
                        ...
                        <p class="col-sm-7">"I can verify the electronic receipt of payment from Soup to Go, for invoice #41888 in the amount of $56,287.11 received on 01/28/X4."</p>
                    </div> 
                    <div class="row">
            ...
            <div>
                ...
                <a href="/teaching-cases/sprandel-inc/client/kate-burke/client-correspondence/soup-to-go.php" class="btn btn-default pull-right margin-right">Return to Soup to Go</a>
            </div>
        </div>
