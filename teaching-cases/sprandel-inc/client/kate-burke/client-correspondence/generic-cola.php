    	...
    	<div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        	<div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Correspondence for Generic Cola</h3>
                </div>
                <div class="panel-body">
                    <div class="row margin-top-bottom margin-left-right well">
                        ...
                        <p class="col-sm-7">"I have received notice of an electronic payment from Generic Cola for invoice #41687. You can ask internal audit to assist you in verifying receipt of payment, if necessary."</p>
                    </div> 
                    <div class="row">
                    ...
                    <div class="margin-top-bottom">
                        <div class="row">
                            <a href="/teaching-cases/sprandel-inc/client/kate-burke/client-correspondence/generic-cola-internal-audit.php" class="btn btn-primary col-xs-6 col-xs-offset-3">Internal Audit</a>
                        </div>
                    </div>
                </div>
            </div>  
