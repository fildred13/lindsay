    ...
    <div class="container" role="main">
        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        	<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row margin-top-bottom margin-left-right well">
                        ...
                        <p class="col-sm-7">"I can help you verify the electronic receipt of payment from The Bath & Body Shop, for invoice #41786 in the amount of $412,426.15 received on 02/18/X4."</p>
                    </div> 
                    <div class="row">
            ...
            <div>
                ...
                <a href="/teaching-cases/sprandel-inc/client/john-sawyer/client-correspondence/bath-body-shop.php" class="btn btn-default pull-right margin-right">Return to The Bath &amp; Body Shop</a>
            </div>
        </div>
