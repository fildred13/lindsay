    	...
    	<div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        	<div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title">Correspondence for Diet Water</h3>
                </div>
                <div class="panel-body">
                    <div class="row margin-top-bottom margin-left-right well">
                        ...
                        <p class="col-sm-7">"I have spoken with the vendor and they have scheduled the payment of invoice #41965 for their next accounts payable which is in 10 days."</p>
                    </div> 
                </div>
            </div>  
            <div>
