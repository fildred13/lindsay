...
<html lang="en">
  ...
  <body>
        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p>To discuss a specific issue you have uncovered during your audit work with John Sawyer input the identification number on the sample item you want to discuss. For example, if you want to ask about a discrepancy with a sample item in your AR Testwork, you should input the Invoice # (e.g., 12345) in the below open text box. Only input the numbers, do NOT input any words, letters, or symbols. John Sawyer can only answer questions about issues associated with his responsibilities and evidence that he has provided to the auditors, therefore if you have questions about work or evidence received from other personnel you should contact them directly.</p>

                    <form id='john-sawyer-ask-issues-form'>
    ...
    <script src="/teaching-cases/sprandel-inc/client/john-sawyer/ask-about-issues.js"></script>
